...
import argparse
import os
os.environ["CUDA_VISIBLE_DEVICCES"]='7'
if __name__ == '__main__':
    ...
    parser.add_argument('-cpu', default=16, type=int, help='How many threads are allowed?')
    ...
    # 1.2. Paths
    parser.add_argument('-dataset_path', default='/home/data/wyq/ABAW_VA/ABAW2-test/ABAW2-EXP/au_dataset_test/Affwild2_processed', type=str,
    ...
    parser.add_argument('-save_path', default='/home/data/zhangzr22/abaw/ABAW6_test_video/save', type=str,
                        help='The path to save the trained models ')  # /scratch/users/ntu/su012/trained_model
    parser.add_argument('-python_package_path', default='/home/data/zhangzr22/abaw/ABAW6_test_video', type=str,
    ...
    parser.add_argument('-experiment_name', default="ABAW6", help='The experiment name.')
    parser.add_argument('-stamp', default='second', type=str, help='To indicate different experiment instances')
    ...
    parser.add_argument('-modality', default=["video"])#, 'mfcc', 'vggish'])
    ...
    parser.add_argument('-patience', default=4, type=int, help='Patience for learning rate changes.')
    parser.add_argument('-factor', default=0.2, type=float, help='The multiplier to decrease the learning rate.')
    parser.add_argument('-gradual_release', default=8, type=int, help='Whether to gradually release some layers?')
